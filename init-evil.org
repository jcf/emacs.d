...
Evil is completely and utterly broken within ansi-term and multi-term. Changing
words, deleting the line updates the contents of the buffer but does nothing to
actually change the state of the term.

This completely disables evil in term modes.
