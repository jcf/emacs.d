...
** Clojure
   ...
   #+begin_src emacs-lisp
     (use-package clojure-mode
       :commands (clojure-mode scratch cider cider-jack-in)
       :config
       (progn
       ...
       (use-package cider
         ...
         :config
         (progn
           ;; Disabled because eldoc keeps timing out.
           ;;
           ;;     eldoc error: (error Sync nREPL request timed out (op info session
           ;;     e22d7fc7-a4ef-495d-ae7b-94f0b6cb5a92 ns user symbol :aliases id 9))
           ;;
